    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<header class="entry-header">
					...
					if ('' != get_the_post_thumbnail()) {
						...
						<div style="font-size:20px; padding-left:10px; padding-bottom:20px; padding-top:10px;position:absolute; bottom:0px; background-color:rgba(44, 62, 81, 0.87); padding-right:10px; color:white" class="cap"><?php _e(the_title(), 'harmonux') ?></div>
           ...
           <?php
					...
					if (is_search()) : // Only display Excerpts for Search
						...
						<div class="entry-content">
							<?php //the_excerpt(__('Continue reading', 'harmonux') . ' <i class="fa fa-angle-right"></i>'); ?>
